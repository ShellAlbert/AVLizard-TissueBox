...
ZImgCapThread::ZImgCapThread(QString devUsbId,qint32 nPreWidth,qint32 nPreHeight,qint32 nPreFps)
{
...
void ZImgCapThread::ZBindOutFIFO(QQueue<QByteArray*> *freeQueue,QQueue<QByteArray*> *usedQueue,///<
...
void ZImgCapThread::run()
{
    ...
    QString devName=this->m_devUsbId;
    while(!gGblPara.m_bGblRst2Exit)
    {
        ZCAMDevice *camDev=new ZCAMDevice(this->m_devUsbId,this->m_nPreWidth,this->m_nPreHeight,this->m_nPreFps);
        ...
        while(!gGblPara.m_bGblRst2Exit)
        {
            ...
            }else if(ret>0)
            {
                ...
                if(gGblPara.m_bJsonFlushUIImg)
                {
                    ...
                    //qDebug()<<"captured one frame okay.";
                }
